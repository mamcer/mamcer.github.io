...
layout: post
title: Tips
subtitle: General work experience tips
---

The following are just some 'tips' that helped me (and most of them are still helping me) in my professional career. They don't pretend to be an exhaustive list neither absolute truths relevant to any situation and context. Also I don't pretend to get credit as the 'creator' of this techniques, some (maybe most) of them could sound like just common sense for a lot of people. It is just a small compilation from mentors I was lucky to have throughout my career, articles or blog post or even tweets that since several years ago I was particularly interested on and of course personal experience. We can maybe even don't agree in some of them and that is fine, maybe in the comments section we can start a respectful conversation and in my case discover other points of view

After that big but I think necessary disclaimer let start in no particular order

Who should read this? I'm passionate about software, team development and user impact. I started my career as a developer, single contributor to different projects my career led me to a management position. I like to think anyone in one of these positions or career stage could find this useful

## Zip file and an unnecesary late feedback

A short story, several years ago when we were just beginning our career in IT. My girlfriend was doing small jobs as a 'webmaster', her client sent her a new job with an attached zip file by email. She just saw it and left in the inbox for later. When it was definitely time to give an answer and show progress, she opened the mail, downloaded the zip but could not open it: 'corrupted file'. She had to send an email basically confessing that in all this time she had not even tried to open the file
...
Taken to the limit can be dangerous. But an interpretation is that we should keep the flow, if our answer or work will take let say less than ten minutes and that will enable other person or team continue the work we should must probably do it now, don't schedule it, don't add it to your calendar or todo list. Execute it  
...
This is particularly important if your are interested in the outcome. If you are interested in the completion of a task or goal why should you put yourself in a blocker or holding position?
...
Also another detail, we need to pay attention to the source and people involved in the communication. For example if the thread started as an email with a lot of people involved, then favoring eficiency switched to a slack conversation or a quick meeting with a small set of the original people it is almost always a good idea to communicate the agreed definition to the original thread (email in this example) so all the initial people are in the same page, we 'close the communication cicle'

In some cases we are not responsible to close the cycle, for example we develop a fix to a reported issue, we inform about it but not get confirmation. Sometimes no-news is good-news but we can always try to force an answer by friendly explicitely asking for a confirmation about the fix in this example

## Sharpen your tools

Like in different level with several or most of the tips included in this list, this is basically a personal opinion 

In my opinion we are responsible of our work tools. Keeping them in good shape and ready to work. Be that a hammer, a car or in my case a laptop or a smartphone
...
greeting  
quickly explain issue or situation that need an action  
action  

greeting: It could be just Hello or Hi [name] or if you get to know the person it could be something more lengthly and also informal. It is important in my opinion to correctly greet people, avoid start directly with the message or action or just mentioning the Name of the person, some people (like me) find it nearly rude

quickly explain issue or situation that need an action: the issue, what needs to be done or in some cases context for a specific question or action
...
My interpretation some years later was that in most cases technology does not exists by itself. It is accompanied by a business that gives it more meaning, like solving real people problems. In that context technology is a powerfull tool
...
Sometimes this is also not related with effort, for example a full migration of the solution to the latest tool/library/framework version. That could involve a lot of work from the team maybe adapting the code and rewriting some parts, fixing broken unit tests, integration tests, etc. When maybe a new feature over the current solution will add more value and is 'cheaper' in terms of effort

Sometimes a full migration is mandatory because for example we are at the end of support of a critical component we rely, sometimes it pays off in the long term, sometimes we are targetting team motivation. It is a matter of balance, in most cases we all like to work with the latest technology but we also like to reach goals, have impact and not always they are closely related
...
In the other hand it is impossible to maintain a 100% rate all the time, at least in a healthy way. Know your limits, register when you are in a higher demand rate. Make it an exception, make it explicitely known by you and the team. We are making this extra effort to meet goal X for example
...
There will be always priorities and urgencies. Our backlog is infinite we should work according to priorities and keep them updated
...
Look and prioritize hard data: percentage of cases, ocurrences over unit of time or total number, etc. They will definitely help prioritize the situation and take an informed decision
...
Email minute of meetings (MOM) in my opinion are very powerfull tools to align expectations, ensure that we all understand the same and are on the same page, generate commitments, evidence and follow up on future meetings. Good MOM have also an actions section with explicit owners and dates
...
In some cases it not even need to be the result of a meeting. It could be to agree or inform a group of people or teams interested in the topic of a commitment agreed in a group slack conversation for example
...
Partial changes allows partial feedback and in several cases allow other team to start working. Sometimes other team not even expect the full answer as the next step
...
In that context you should ask questions. Ask good questions is a completely separated skill. I'm definitely still learning but I can mention some tips:
...
- Give options, most people want to help you and is very valuable have a list (small, a lot of options also could be counterproductive) to help her/him have context, understand your requirement and help you. Also it is a proof that we were making some work. Give options A, B, C, you are not sure with which to choose, so the question, the other person can help you define one of those or identify an option D that you didn't take into account
...
They exist an infinite number of time management strategies and recommendations. I like to mention the Eisenhower box as it helped me recognize my time waster and organize in a better way my time
...
If you for example are responsible of a project delivery then you can lead a team to achive the goal. In a very simplistic way if the goal is not achieved then the team fails, but if there is any individuality is in you
...
For example if someone ask us for a glass of water: deliver a bottle of water, a half empty glass or some money to buy your own water are just optimal solutions. Probably the receptor can finish the work, but that is what we are providing in these cases: unfinished work

Definitely understanding the requirement and deliver the request no more, no less in an aceptable time is invaluable
...
Don't try to minimize knowledge or career of other people, be respectful. This was particularly true in my case at the beginning of my career regarding other roles in the team
...
Don't be rude, don't push too much. The best thing that we can aspire is to meet goals and make new friends in the process. It is all about the journey
